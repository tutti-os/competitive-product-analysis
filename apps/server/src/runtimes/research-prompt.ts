...
export function buildResearchSystemPrompt(context: ResearchRunContext): string {
  ...
  return [
    ...
    "Important host override: you are already the exact Agent Target selected for this run. Execute every research stage yourself in this process. Do not execute the skill root `run.py`, do not invoke any provider CLI, and do not launch any other provider-specific or nested agent process, even if SKILL.md recommends that launcher.",
